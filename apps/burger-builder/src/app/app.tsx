...
import { BurgerBuilderLib } from '@git-explorer/burger-builder-lib';
  ...
  `}</pre>
      ...
      <div role="navigation">
        <ul>
          ...
          <li>
            <Link to="/burger-builder-lib">BurgerBuilderLib</Link>
          </li>
          <li>
      ...
      />
      <Route path="/burger-builder-lib" component={BurgerBuilderLib} />
      <Route
        path="/page-2"
        exact
        render={() => (
